...
class TonAPI {
    ...
    createProviderByGETBLOCKV2() {
        ...
        const endpoint = `https://go.getblock.io/${process.env.GETBLOCK_JSON_RPC_API_KEY}/jsonRPC`;
        let apiKey;
        return {
            endpoint,
            apiKey,
    ...
    createProviderByGETBLOCKV3() {
        ...
        const endpoint = `https://go.getblock.io/${process.env.GETBLOCK_INDEXER_V3_API_KEY}/api/v3`;
        let apiKey;
        return {
            endpoint,
            apiKey,
